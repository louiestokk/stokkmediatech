  ...
  return (
    <div className={styles.showcasesmother} style={{padding:'1rem'}}>
      <div style={{height:'30px'}}></div>
        ...
        <Link className={styles.abbs} style={{fontSize:'0.8rem',color:'#ff3ff2',display:'flex',alignItems:'center',width:'100%'}} href={'/showcases'}>See more we've done <ArrowRightAltIcon style={{marginTop:'0.2rem',marginLeft:'0.2rem'}}/></Link>
              <div style={{height:'30px'}}></div>
      <section>
        <Link target='_blank' href={'https://hotmat.se/'}>
       ...
       <Link target='_blank' href={'https://yumyum.se/'}>
