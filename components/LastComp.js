   ...
   <div className={styles.lisa}>
         <div style={{ width: '100%', marginTop: '0rem', padding: '3rem' }}>
            ...
            <div style={{ padding: '0.4rem',display:'flex',flexDirection:'column' }}>
                <FormControlLabel style={{ marginTop: '0.5rem', marginBottom: '1rem',color:'whitesmoke' }} control={<CheckCircleIcon style={{ marginRight: '0.75rem',color:'whitesmoke',borderRadius:'50%',fontSize:'1.7rem' }} />} label={'382 satisfied customers'} />
